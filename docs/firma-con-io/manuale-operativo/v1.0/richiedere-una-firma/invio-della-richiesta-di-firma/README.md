...
A questo punto la richiesta di firma è **pronta per essere inviata** all'utente. Per farlo, hai due modalità: tramite **pulsante** o **QR code** da condividere all'utente attraverso i tuoi canali o inviando direttamente un **messaggio sull'app IO**.
