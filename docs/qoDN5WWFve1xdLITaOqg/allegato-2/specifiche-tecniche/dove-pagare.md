...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/vgIzxa0FaCZjmBRODLgd/allegato-2/specifiche-tecniche/dove-pagare
---
...
![Dettaglio della sezione "Dove pagare" all'interno dell'avviso di pagamento pagoPA.](<../../../../pago-pa/avviso-pagamento/3.5.1/.gitbook/assets/Frame 1 (1).png>)
