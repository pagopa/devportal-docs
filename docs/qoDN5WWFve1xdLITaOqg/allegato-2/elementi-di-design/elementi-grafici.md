...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/vgIzxa0FaCZjmBRODLgd/allegato-2/elementi-di-design/elementi-grafici
---
...
{% file src="../../../../pago-pa/avviso-pagamento/3.5.1/.gitbook/assets/pagoPA-avvisi-350-assets.zip" %}
