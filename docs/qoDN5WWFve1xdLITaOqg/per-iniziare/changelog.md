...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/vgIzxa0FaCZjmBRODLgd/per-iniziare/changelog
---
...
* Nelle [informazioni-sullente-creditore.md](../allegato-2/specifiche-tecniche/informazioni-sullente-creditore.md "mention"), il campo `ENTE.NOME` ora supporta fino a 100 caratteri.
...
{% file src="../../../pago-pa/avviso-pagamento/3.5.1/.gitbook/assets/guidatecnica_avvisoanalogico_v2.2.1_con_alleg (1).pdf" %}
