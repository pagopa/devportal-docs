...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/vgIzxa0FaCZjmBRODLgd/allegato-1/varianti/avviso-senza-scadenza
---
...
{% file src="../../../../pago-pa/avviso-pagamento/3.5.1/.gitbook/assets/pagoPA-Avvisi-340-senzaScadenza.zip" %}
