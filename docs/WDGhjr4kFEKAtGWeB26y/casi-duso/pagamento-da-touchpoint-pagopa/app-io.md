...
![](<../../.gitbook/assets/appIO\_SANP (2).png>)



* l'utente che avvia il pagamento dall'app IO <img src="../../.gitbook/assets/image (30).png" alt="" data-size="line"> deve scansionare il QR code presente sull'avviso di pagamento;
