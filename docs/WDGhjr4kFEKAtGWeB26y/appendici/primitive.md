...
Per i dettagli [https://github.com/pagopa/pagopa-api/tree/SANP3.2.1](https://github.com/pagopa/pagopa-api/tree/SANP3.2.1)
...
{% swagger src="../.gitbook/assets/checkout (1).yaml" path="/carts" method="post" %}
