...
Per i dettagli [https://github.com/pagopa/pagopa-api/tree/SANP3.9.0](https://github.com/pagopa/pagopa-api/tree/SANP3.9.0)
...
| receiptId\*                   | String | Identificatore univoco della _receipt_ che contiene il _paymentToken_ assegnato da pagoPa. |
...
| entityUniqueIdentifierType\*  | String | <p><strong>F</strong> : Persona fisica<br><strong>G</strong> : Persona giuridica.</p>      |
...
{% swagger src="https://raw.githubusercontent.com/pagopa/pagopa-aca-service/refs/heads/main/api-spec/aca-api.yaml" path="/paCreatePosition" method="post" %}
