# Opzione con molteplici piani rateali (con o senza opzione totale)

Con questo scenario è possibile gestire diversi piani rateali.&#x20;

{% hint style="info" %}
La scelta di una **OdP** (di uno specifico piano rateale) da parte del cittadino, disabilita le **OdP** relative agli altri piani e/o l’eventuale opzione unica; in output deve essere restituita soltanto l’OdP con le installment ancora da saldare.&#x20;
{% endhint %}
