...
* **notificationViewDate**: data di visualizzazione della notifica da parte di un destinatario.\
  ...
  **NOTA sul perfezionamento**:\
  ...
  Per ulteriori dettagli: [https://app.gitbook.com/o/KXYtsf32WSKm6ga638R3/s/8hvzBYw259fYwQSqzmf6/\~/changes/15/knowledge-base-di-piattaforma-notifiche/focus-sul-perfezionamento-della-notifica](../readme/focus-sul-perfezionamento-della-notifica.md)
