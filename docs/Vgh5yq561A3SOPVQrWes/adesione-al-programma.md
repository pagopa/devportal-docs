...
{% file src="../app-io/carta-giovani-nazionale/v1.0/.gitbook/assets/Convenzione.pdf" %}
Template del documento di convenzione
{% endfile %}

{% file src="../app-io/carta-giovani-nazionale/v1.0/.gitbook/assets/Allegato 1 - Domanda di adesione.pdf" %}
