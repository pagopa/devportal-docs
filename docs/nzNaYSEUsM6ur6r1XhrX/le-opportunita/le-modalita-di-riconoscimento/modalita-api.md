...
<figure><img src="../../../app-io/carta-giovani-nazionale/v2.0.1/.gitbook/assets/image (6).png" alt=""><figcaption><p><mark style="color:purple;"><strong>Fig.3</strong> Dal dettaglio dell'opportunità, l'utente genera un codice OTP</mark></p></figcaption></figure>

![](../../../app-io/carta-giovani-nazionale/v2.0.1/.gitbook/assets/OTP_01.png) ![](../../../app-io/carta-giovani-nazionale/v2.0.1/.gitbook/assets/OTP_02.png) ![](../../../app-io/carta-giovani-nazionale/v2.0.1/.gitbook/assets/OTP_03.png)
