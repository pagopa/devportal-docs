...
* if [#has\_remote\_content](../../api-and-specifications/api-messages/submit-a-message-passing-the-user-tax-code-in-the-request-body.md#has_remote_content "mention")`=true`, the field [#subject](../../api-and-specifications/api-messages/submit-a-message-passing-the-user-tax-code-in-the-request-body.md#subject "mention") indicated at the moment the message was created is used by IO _only_ in the list of received messages.   
The header visible in the message details is instead retrieved later (see [#what-happens-when-the-recipient-opens-a-remote-message](send-a-message-remote-content.md#cosa-succede-quando-il-destinatario-apre-un-messaggio-remotizzato "mention")).  
