...
Il BackOffice di “Messaggi di Cortesia” è un portale verticale integrato nella piattaforma Area Riservata di PagoPA S.p.A., pensato specificamente per la gestione del prodotto "Messaggi di Cortesia".

Il portale è rivolto ai PSP aderenti a pagoPA (Prestatori di Servizi di Pagamento e permette di gestire e configurare il Servizio "Messaggi di Cortesia", a supporto delle comunicazioni inviate tramite la piattaforma SEND.

Il portale nasce con un obiettivo preciso: offrire un punto di accesso unico per attivare, configurare e gestire il prodotto, garantendo piena autonomia operativa ai PSP aderenti e ai loro delegati.

{% hint style="info" %}
Il BackOffice "Messaggi di Cortesia" è accessibile esclusivamente attraverso la piattaforma Area Riservata di PagoPA S.p.A. e richiede che il PSP abbia previamente aderito al prodotto.
{% endhint %}

### I vantaggi per i PSP

Integrare il BackOffice "Messaggi di Cortesia" consente di semplificare la gestione del Servizio e offre un’esperienza di configurazione centralizzata, sicura e allineata agli standard PagoPA S.p.A.
...
<table><thead><tr><th>Attore</th><th width="512.02734375">Ruolo nel sistema</th></tr></thead><tbody><tr><td>PSP</td><td>Soggetto che aderisce al Servizio "Messaggi di Cortesia" tramite il BackOffice, configura gli endpoint tecnici e gestisce gli utenti abilitati per il proprio PSP.</td></tr><tr><td>Area Riservata (Self Care)</td><td>Piattaforma PagoPA da cui si accede al BackOffice tramite autenticazione SSO. Gestisce identità digitali, ruoli e sessioni utente.</td></tr><tr><td>Backoffice</td><td>Portale verticale integrato nell’Area Riservata che consente ai PSP di gestire in autonomia la configurazione del Servizio "Messaggi di Cortesia".</td></tr><tr><td>Utente</td><td>Destinatario finale del servizio. La corretta configurazione del PSP nel BackOffice consente all'utente di ricevere i messaggi di cortesia SEND direttamente sull’app bancaria</td></tr></tbody></table>
