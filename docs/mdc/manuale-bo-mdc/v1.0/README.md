...
{% hint style="info" %}
Il BackOffice "Messaggi di Cortesia" è accessibile esclusivamente attraverso la piattaforma Area Riservata di PagoPA S.p.A. e richiede che l’Ente abbia previamente aderito al prodotto.
{% endhint %}
