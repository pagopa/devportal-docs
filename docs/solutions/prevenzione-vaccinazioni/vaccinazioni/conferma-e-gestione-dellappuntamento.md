...
<figure><img src="../.gitbook/assets/image (8).png" alt="Immagine che mostra una schermata di app IO con il riepilogo della prenotazione della vaccinazione"><figcaption></figcaption></figure>

### **Cosa fa l'ente:**

* Invia un messaggio di conferma con tutti i dettagli rilevanti e un link per modifica o cancellazione.
