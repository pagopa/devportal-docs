...
<figure><img src="../.gitbook/assets/image (10).png" alt="Immagine che mostra in tre schermate di app IO il flusso per visualizzare lo storico delle vaccinazioni"><figcaption></figcaption></figure>
...
* **Integra la visualizzazione dello storico nella scheda servizio di App IO**: Consenti l’accesso diretto tramite Single Sign-On al Fascicolo Sanitario.
...
* **Prevedi l’accesso per delegati o tutori**: Abilita nel Fascicolo Sanitario la consultazione per genitori o caregiver con opportuna autorizzazione.
