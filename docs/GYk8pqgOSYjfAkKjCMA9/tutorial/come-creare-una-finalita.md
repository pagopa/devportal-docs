...
* **stima di carico**: quante chiamate API/giorno il fruitore stima di fare verso le API dell'erogatore. Maggiori informazioni nella [sezione dedicata](../guida-tecnica/e-service/soglie-di-carico.md).
