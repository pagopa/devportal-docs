...
L'URL del servizio e la specifica OpenAPI dell'interfaccia sono reperibili all'interno della sezione _Fruizione > I tuoi client API interop_, all'interno di qualsiasi client machine to machine venga creato.
