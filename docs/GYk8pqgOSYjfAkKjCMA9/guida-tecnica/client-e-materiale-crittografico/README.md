...
Il primo tipo di client, il _**client API e-service**_, sarà associabile agli e-service per i quali un fruitore ha una richiesta di fruizione attiva e almeno una finalità pubblicata.
...
Il secondo, il _**client API Interoperabilità**_, non andrà associato a niente e sarà direttamente utilizzabile per ottenere informazioni da PDND Interoperabilità attraverso le sue API.
