...
Per maggiori informazioni, si veda il tutorial pratico. \[TBD]
...
Impiegato da tutti quei servizi per i quali gli erogatori chiedono ai fruitori dettagli aggiuntivi relativi alla chiamata. In questo flusso, PDND non ha visibilità su questi dati aggiuntivi scambiati tra erogatore e fruitore.&#x20;

PDND agisce comunque da notaio, confermando sia all'erogatore che al fruitore l'integrità dei dati aggiuntivi che transitano e conservandone un riferimento. Un esempio di applicazione di questo pattern sono i servizi dell'ANPR.
