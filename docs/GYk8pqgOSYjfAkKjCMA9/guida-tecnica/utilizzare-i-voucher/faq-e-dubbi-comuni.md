...
Dipende dal tipo di voucher: Bearer Token ([base](../../tutorial/fruitore/voucher/come-richiedere-un-voucher-bearer-per-le-api-di-un-erogatore-base.md) o [con informazioni aggiuntive](../../tutorial/fruitore/voucher/come-richiedere-un-voucher-bearer-per-le-api-di-un-erogatore-con-informazioni-aggiuntive.md)) o DPoP ([base](../../tutorial/fruitore/voucher/come-richiedere-un-voucher-dpop-per-le-api-di-un-erogatore-base.md) o [con informazioni aggiuntive](../../tutorial/fruitore/voucher/come-richiedere-un-voucher-dpop-per-le-api-di-un-erogatore-con-informazioni-aggiuntive.md)). In ognuno dei tutorial dedicati viene indicato come è strutturato il voucher.
