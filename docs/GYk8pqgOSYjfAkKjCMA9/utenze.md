...
Seleziona la voce _**Utenti**_ dal menu a sinistra e poi, clicca su _**Aggiungi utente**_&#x20;
...
Dopo l'assegnazione del ruolo, il nuovo utente riceve una notificata d'iscrizione all'indirizzo email indicato nel form di creazione. Il nuovo utente può quindi accedere alla Piattaforma Area Riservata (Self Care) dove può selezionare "PDND Interoperabilità" tra i prodotti disponibili per la sua utenza e cliccare su _**Gestisci**_ per accedere al servizio PDND Interoperabilità.
