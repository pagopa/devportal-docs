...
Questi attributi semplificano la gestione dell'erogazione, permettendo anche al certificatore di creare e gestire dei "network" di enti che possiedono particolari caratteristiche. Per esempio, A.N.A.C. agisce come ente certificatore che gestisce il network dell'_e-procurement_, avendo visibilità non solo dei propri e-service, ma di tutti gli enti ai quali ha conferito attributi specifici per accedere ai servizi legati ai flussi di e-procurement.
