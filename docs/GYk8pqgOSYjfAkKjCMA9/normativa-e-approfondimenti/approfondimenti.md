...
PDND Interoperabilità autentica e autorizza gli aderenti, abilitando lo scambio di informazioni tra le parti senza che i dati detenuti dagli erogatori transitino sulla piattaforma.&#x20;

Il Gestore della piattaforma, rappresentato da PagoPA S.p.A., è qualificato come titolare del trattamento dei dati personali ai sensi del Paragrafo 14 delle [Linee guida AgID](https://trasparenza.agid.gov.it/moduli/downloadFile.php?file=oggetto_allegati/213481831510O__O20211210_LG+Infrastruttura+Interoperabilit%26%23224%3B+PDND_v1.pdf), passate al vaglio anche del Garante.&#x20;

Da notare che i dati a cui si fa riferimento sono esclusivamente quelli depositati o generati all'interno della piattaforma; i dati in possesso degli erogatori non transitano mai su PDND Interoperabilità.
...
### Limitazioni delle responsabiltà
