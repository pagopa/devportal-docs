...
![](<../../../pago-pa/sanp/3.8.0/.gitbook/assets/appIO_SANP (3).png>)

* l'utente che avvia il pagamento dall'app IO <img src="../../../pago-pa/sanp/3.8.0/.gitbook/assets/image.png" alt="" data-size="line"> deve scansionare il QR code presente sull'avviso di pagamento;
