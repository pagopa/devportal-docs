...
![](<../../../pago-pa/sanp/3.8.0/.gitbook/assets/createPD (1).png>)
...
![](../../../pago-pa/sanp/3.8.0/.gitbook/assets/readPDList.png)
...
![](../../../pago-pa/sanp/3.8.0/.gitbook/assets/readPD.png)
...
![](../../../pago-pa/sanp/3.8.0/.gitbook/assets/updatePD.png)
...
![](<../../../pago-pa/sanp/3.8.0/.gitbook/assets/deletePD (1).png>)
...
{% openapi src="../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_core.json" path="/organizations/{organizationfiscalcode}/debtpositions/{iupd}/publish" method="post" %}
[gpd_core.json](../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_core.json)
{% endopenapi %}

![](../../../pago-pa/sanp/3.8.0/.gitbook/assets/publishPD.png)
...
{% openapi src="../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_core.json" path="/organizations/{organizationfiscalcode}/debtpositions/{iupd}/invalidate" method="post" %}
[gpd_core.json](../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_core.json)
{% endopenapi %}

![](../../../pago-pa/sanp/3.8.0/.gitbook/assets/invalidatePD.png)
...
<figure><img src="../../../pago-pa/sanp/3.8.0/.gitbook/assets/readReceiptList.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../pago-pa/sanp/3.8.0/.gitbook/assets/readReceipt.png" alt=""><figcaption></figcaption></figure>
...
{% openapi src="../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_fdr.yaml" path="/organizations/{organizationId}/reportings" method="get" %}
[gpd_fdr.yaml](../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_fdr.yaml)
{% endopenapi %}

![](../../../pago-pa/sanp/3.8.0/.gitbook/assets/readFdRList.png)

{% openapi src="../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_fdr.yaml" path="/organizations/{organizationId}/reportings/{flowId}/date/{date}" method="get" %}
[gpd_fdr.yaml](../../../pago-pa/sanp/3.8.0/.gitbook/assets/gpd_fdr.yaml)
{% endopenapi %}

![](../../../pago-pa/sanp/3.8.0/.gitbook/assets/readFdR.png)
