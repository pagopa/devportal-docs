# How to update an e-service without publishing a new version
...
For the editable field, there will be a pencil icon with the label _**Edit**_. By clicking it, a side panel will open to make the change.
