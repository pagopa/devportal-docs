...
1. Authenticate on the PDND APIs as described in the [dedicated flow](../../tutorials/tutorials-for-consumers/voucher/how-to-request-a-bearer-voucher-for-pdnd-apis.md).
