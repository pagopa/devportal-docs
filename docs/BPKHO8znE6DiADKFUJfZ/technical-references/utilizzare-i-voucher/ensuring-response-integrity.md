...
In the dedicated tutorials for [producer](../../tutorials/tutorials-for-producers/voucher/how-to-sign-a-response-for-a-subscriber.md) and [consumer](../../tutorials/tutorials-for-consumers/voucher/how-to-verify-a-response-signed-by-a-producer.md), a sample implementation of the response payload signing mechanism is provided.
