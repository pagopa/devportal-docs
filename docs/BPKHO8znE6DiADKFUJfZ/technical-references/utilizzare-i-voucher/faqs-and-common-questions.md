...
For any doubts, a practical example of a client assertion is available [here](../../tutorials/tutorials-for-consumers/voucher/how-to-request-a-bearer-voucher-for-pdnd-apis.md#il-flusso-in-breve-2).
...
It depends on the type of voucher: Bearer Token ([basic](../../tutorials/tutorials-for-consumers/voucher/how-to-request-a-bearer-voucher-for-a-producers-api-standard.md) o [with additional information](../../tutorials/tutorials-for-consumers/voucher/how-to-request-a-bearer-voucher-for-a-producers-api-with-additional-information.md)) or DPoP ([basic](../../tutorials/tutorials-for-consumers/voucher/how-to-request-a-dpop-voucher-for-a-producers-api-standard.md) o [with additional information](../../tutorials/tutorials-for-consumers/voucher/how-to-request-a-dpop-voucher-for-a-producers-api-with-additional-information.md)). In each dedicated tutorial, the structure of the voucher is explained.
