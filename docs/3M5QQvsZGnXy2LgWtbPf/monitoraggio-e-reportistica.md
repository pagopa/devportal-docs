...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/Y7k2HeXaC1tCaS4VWENZ/pagamento-della-prestazione-sanitaria
---

# 5️⃣ Monitoraggio e Reportistica

SEND fornisce strumenti avanzati per il controllo dell'intero ciclo di vita della notifica.

### Cosa fa l'ente

* **Monitora gli stati e i pre-esiti:** Verifica l'accettazione del deposito, l'invio, e il perfezionamento (avvenuta consegna o compiuta giacenza).
* **Consulta i report:** Mensilmente SEND invia un report delle notifiche perfezionate, fondamentale per la riconciliazione contabile e la gestione di eventuali contenziosi.
