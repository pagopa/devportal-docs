...
* **Riceve il messaggio di adesione:** Un messaggio tramite app IO, email o SMS la informa dell'esistenza della notifica.
...
* **Promuovi l'uso del domicilio digitale**: è un canale immediato, economico e con piena validità legale
...
* **Monitoraggio:** L'ente può verificare tramite API l’accettazione o il rifiuto da parte di SEND del deposito della notifica. Una volta accettato il deposito, potrai monitorare anche i diversi stati della notifica.

### Benefici per l'ente e per il cittadino ✅

* **Il cittadino sceglie come ricevere le notifiche:** Si adatta al contesto del destinatario, raggiungendolo dove il cittadino preferisce
