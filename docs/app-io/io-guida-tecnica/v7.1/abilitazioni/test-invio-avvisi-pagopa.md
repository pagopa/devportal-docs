...
Per poter inviare avvisi di pagamento pagoPA, in fase di test puoi scrivere all’indirizzo email [areariservata@assistenza.pagopa.it](mailto:areariservata@assistenza.pagopa.it) specificando:
