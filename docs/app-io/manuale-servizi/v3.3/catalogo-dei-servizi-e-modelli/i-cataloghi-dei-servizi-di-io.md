...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/S2wztmuR1C8bWqvZAbwN/catalogo-dei-servizi-e-modelli/i-cataloghi-dei-servizi-di-io
---
...
{% hint style="info" %}
Se non trovi un Catalogo che rappresenta il tuo ente o il servizio di cui hai bisogno, puoi decidere di pubblicare un servizio che non fa parte del Catalogo. Il servizio tuttavia verrà sottoposto a **controllo manuale** e verrà valutato secondo quanto scritto in questo Manuale. Dunque, non è assicurata l'approvazione — come invece avviene se si sceglie un servizio a catalogo.
{% endhint %}
