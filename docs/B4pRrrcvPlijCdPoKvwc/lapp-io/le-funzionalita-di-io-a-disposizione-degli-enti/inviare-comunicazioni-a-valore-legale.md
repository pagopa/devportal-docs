...
SEND fa delle verifiche tecniche e se i requisiti di cui al manuale tecnico sono soddisfatti, prende in carico la notifica. Ad ogni cambio di stato, viene sempre generata la relativa attestazione opponibile a terzi.
{% endstep %}
...
Se il destinatario accede alla piattaforma, può scaricare i documenti notificati e pagare contestualmente quanto dovuto con pagoPA. Se la riceve tramite IO, può operare direttamente in app.
{% endstep %}
{% endstepper %}
