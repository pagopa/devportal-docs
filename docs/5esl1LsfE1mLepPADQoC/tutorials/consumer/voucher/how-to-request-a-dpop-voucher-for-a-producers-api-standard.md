...
To consult the recommended checks for producers, see the [dedicated section](../../../technical-guide/utilizzare-i-voucher/checks-on-a-dpop-voucher-by-a-producer.md).
