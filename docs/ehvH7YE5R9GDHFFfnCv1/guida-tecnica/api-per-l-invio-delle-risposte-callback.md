...
schema:
  ...
  '@type': WebAPI
  description: >-
    Descrizione tecnica dell'API che un Service Provider del Debitore deve
    utilizzare per inviare risposte asincrone alla piattaforma PagoPA,
    recuperando dinamicamente l'URL di notifica dal campo callbackUrl della
    richiesta originale.
  isPartOf:
  ...
  potentialAction:
    ...
    expects:
      '@type': Thing
      description: >-
        Wrapper contenente un messaggio ISO 20022, ad esempio un pain.014 per
        una risposta di stato.
