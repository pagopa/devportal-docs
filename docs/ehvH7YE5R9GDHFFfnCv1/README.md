...
schema:
  ...
  author:
    ...
    name: PagoPA S.p.A.
  description: >-
    Descrive il servizio Request to Pay (RTP) come canale digitale per ricevere
    richieste di pagamento, basato sullo standard europeo SEPA Request-To-Pay
