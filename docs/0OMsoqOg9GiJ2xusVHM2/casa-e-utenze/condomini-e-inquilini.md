...
### Appuntamento sportello consulenza condominiale
...
{% file src="../.gitbook/assets/IO - Template servizi - Condomini e inquilini.xlsx" %}
{% endhint %}
