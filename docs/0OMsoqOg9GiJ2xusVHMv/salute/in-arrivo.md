...
<figure><img src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/image (27).png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Prevenzione</strong></p></figcaption></figure>
...
{% file src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Prevenzione.xlsx" %}
{% endhint %}
