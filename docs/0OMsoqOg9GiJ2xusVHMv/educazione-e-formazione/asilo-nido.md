...
<figure><img src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/Educazione e formazione_Asili nido (1).png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Asilo Nido</strong></p></figcaption></figure>
...
{% file src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Asilo nido.xlsx" %}
{% endhint %}
