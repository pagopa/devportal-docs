...
<figure><img src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/Attività produttive e commercio_Sportello Unico per le Attività Produttive (SUAP).png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Sportello Unico per le Attività Produttive</strong></p></figcaption></figure>
...
{% file src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Sportello Unico per le Attività Produttive (SUAP).xlsx" %}
{% endhint %}
