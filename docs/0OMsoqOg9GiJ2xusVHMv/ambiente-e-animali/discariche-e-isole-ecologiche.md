...
<figure><img src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/image (32).png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Discariche e isole ecologiche</strong></p></figcaption></figure>
...
{% file src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Discariche e isole ecologiche.xlsx" %}
{% endhint %}
