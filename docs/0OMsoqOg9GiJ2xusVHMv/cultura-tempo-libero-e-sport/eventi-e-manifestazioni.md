...
<figure><img src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/image (39) (1).png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Eventi e manifestazioni</strong></p></figcaption></figure>
...
{% file src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Eventi e manifestazioni.xlsx" %}
{% endhint %}
