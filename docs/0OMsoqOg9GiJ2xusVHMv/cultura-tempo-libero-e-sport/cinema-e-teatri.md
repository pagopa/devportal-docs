...
<figure><img src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/image (38) (1).png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Cinema e teatri</strong></p></figcaption></figure>
...
{% file src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Cinema e teatri.xlsx" %}
{% endhint %}
