...
<figure><img src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/image (18) (1).png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Passo carrabile</strong></p></figcaption></figure>
...
{% file src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Passo carrabile.xlsx" %}
{% endhint %}
