...
<figure><img src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/Servizi anagrafici_Cittadinanza italiana.png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Cittadinanza italiana</strong></p></figcaption></figure>
...
{% file src="../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Cittadinanza italiana (1).xlsx" %}
{% endhint %}
