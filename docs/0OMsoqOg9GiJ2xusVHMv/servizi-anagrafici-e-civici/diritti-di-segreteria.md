...
<figure><img src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/Servizi anagrafici_Diritti di segreteria.png" alt=""><figcaption><p><strong>Ciclo di vita ed eventi del servizio Diritti di segreteria</strong></p></figcaption></figure>
...
{% file src="../../../app-io/modelli-servizi/v1.0/.gitbook/assets/IO - Template servizi - Diritti di segreteria (1).xlsx" %}
{% endhint %}
