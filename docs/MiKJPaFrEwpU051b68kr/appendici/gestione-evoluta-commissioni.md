...
![](../../pago-pa/sanp/3.6.0/.gitbook/assets/MarketPlace.png)
...
* ogni PSP può offrire i propri pacchetti privati agli EC;
* ogni PSP può accettare le richieste di adesione degli EC ai propri pacchetti pubblici;
* ogni PSP può accettare le modifiche di adesione degli EC ai propri pacchetti pubblici;
* ogni EC ha a disposizione delle interfacce CRUD per gestire i pacchetti a cui ha accesso;
* ogni EC può farsi carico di una quota commissionale per ogni pacchetto pubblico o privato a cui ha accesso;
