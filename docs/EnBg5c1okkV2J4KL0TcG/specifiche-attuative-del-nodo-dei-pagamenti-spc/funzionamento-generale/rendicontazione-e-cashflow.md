...
1. **Avvio del caricamento flusso:**\
   Il PSP avvia il processo notificando al sistema l’intenzione di inviare un nuovo flusso di rendicontazione.
2. **Invio dei pacchetti:**\
   Il flusso può essere suddiviso in più pacchetti di dimensioni ridotte, che vengono inviati singolarmente. Questa operazione può essere ripetuta fino al completamento del flusso.
3. **Eliminazione di un pacchetto:**\
   È possibile rimuovere un pacchetto precedentemente caricato in caso di errore.
4. **Pubblicazione del flusso:**\
   Una volta inviati tutti i pacchetti, il flusso può essere pubblicato per renderlo disponibile agli Enti Creditori (EC).
5. **Cancellazione dell'intero flusso:**\
   In alternativa alla pubblicazione, è possibile eliminare tutti i pacchetti associati a un flusso.

#### **Lato Ente Creditore:**

1. **Richiesta dell'elenco dei flussi disponibili:**\
   L’EC può richiedere l’elenco dei flussi di rendicontazione non ancora scaricati.
