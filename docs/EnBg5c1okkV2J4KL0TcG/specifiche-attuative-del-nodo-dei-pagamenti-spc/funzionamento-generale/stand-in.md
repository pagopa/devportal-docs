...
In questo caso il pagamento viene gestito in modalità Stand In e al termine del pagamento la piattaforma pagoPA effettua l'invio della ricevuta telematica tramite la [paSendRTV1/V2](../../appendici/primitive/ente-creditore/api-soap.md#pasendrt) utilizzando le modalità standard dettagliate in [#fase-invio-ricevuta](../../ente-creditore/modalita-dintegrazione/integrazione-tramite-api-sincrone.md#fase-invio-ricevuta "mention").
...
* [verifyPaymentNotice](../../appendici/primitive/psp/api-soap.md#activatepaymentnotice) response
* [verificaBollettino](../../appendici/primitive/psp/api-soap.md#verificabollettino) response
* [activatePaymentNoticeV1/V2](../../appendici/primitive/psp/api-soap.md#activatepaymentnotice-1) response
* [pspNotifyPaymentV1/V2](../../appendici/primitive/psp/api-soap.md#pspnotifypayment) request
* [paSendRTV1/V2](../../appendici/primitive/ente-creditore/api-soap.md#pasendrt) request.
...
Le logiche per attivare la funzionalità si fondano sulle primitive [paVerifyPaymentNotice](../../appendici/primitive/ente-creditore/api-soap.md#paverifypaymentnotice) e [paGetPaymentV1/V2](../../appendici/primitive/ente-creditore/api-soap.md#pagetpayment), di queste primitive si monitorano i seguenti faultCode:
...
Le logiche per disattivare la funzionalità si fondano sulla primitiva [paVerifyPaymentNotice](../../appendici/primitive/ente-creditore/api-soap.md#paverifypaymentnotice), in particolare, nel periodo in cui la stazione si trova in Stand In, vengono effettuate chiamate tecniche per verificare il ripristino delle operatività della stazione.

Per le chiamate tecniche alla primitiva [paVerifyPaymentNotice](../../appendici/primitive/ente-creditore/api-soap.md#paverifypaymentnotice) si utilizzerà uno IUV fittizio (_000000000000000000_) in modo da ottenere _PAA\_PAGAMENTO\_SCONOSCIUTO,_ in caso di una percentuale minima del 50% di risposte positive la condizione di Stand In della stazione viene disabilitata, ripristinando la normale configurazione operativa della stazione dell'EC.
