...
![](../../9E4vGfV6bOPGpOwZoKIm/.gitbook/assets/oggettiBusiness.png)
...
La _**receipt**_ (ricevuta) è un oggetto generato dalla piattaforma pagoPA sulla base dei dati ricevuti dalla response alla [paGetPayment](../appendici/primitive/ente-creditore/api-soap.md#pagetpayment) (da EC) e dalla [sendPaymentOutcome](../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) (da PSP); viene inviato agli _n_ Enti Creditori interessati al pagamento per mezzo della primitiva [paSendRT](../appendici/primitive/ente-creditore/api-soap.md#pasendrt); l’oggetto _receipt_ viene inoltrato all’EC solo se il pagamento è stato effettuato.
...
![](../../xStAOBVhMPuBPPjhED2d/.gitbook/assets/flussiRendicontazione.png)

## Strutture dati di supporto <a href="#strutture-dati-business" id="strutture-dati-business"></a>

![](../../9E4vGfV6bOPGpOwZoKIm/.gitbook/assets/oggettiSupporto.png)
...
{% hint style="info" %}
La Tabella delle controparti estesa è stata deprecata, per ulteriori dettagli fare riferimento alla pagina [Funzionalità deprecate](../appendici/funzionalita-deprecate.md)
{% endhint %}
...
![](<../../9E4vGfV6bOPGpOwZoKIm/.gitbook/assets/image (40).png>)
