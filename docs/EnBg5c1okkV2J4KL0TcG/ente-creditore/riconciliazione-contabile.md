...
Per far transitare sulla piattaforma pagoPA le informazioni utili alla riconciliazione contabile è necessario sfruttare la struttura dei _metadata_ disponibile nelle primitive [paGetPayment vers. 2](../appendici/primitive/ente-creditore/api-soap.md#pagetpayment-versione-2) e [paSendRT vers. 2](../appendici/primitive/ente-creditore/api-soap.md#pasendrt-versione-2).
...
![](../../pago-pa/sanp/3.11.0/.gitbook/assets/flussoMetadataEC.png)
...
* la [paSendRT vers. 2](../appendici/primitive/ente-creditore/api-soap.md#pasendrt-versione-2) viene inoltrata
...
Sfruttando tale flusso ogni software degli EC coinvolti nel pagamento potrebbe ricevere la [paSendRT vers. 2](../appendici/primitive/ente-creditore/api-soap.md#pasendrt-versione-2) e utilizzare il contenuto dei _metadata_ per gestire la riconciliazione contabile.
