...
Tutti i dettagli relativi al funzionamento della nuova API [paVerifyPaymentOptions](../../appendici/primitive/ente-creditore/api-rest/#pagetpayment) sono disponibili nella pagina [primitive](../../appendici/primitive/ "mention").
