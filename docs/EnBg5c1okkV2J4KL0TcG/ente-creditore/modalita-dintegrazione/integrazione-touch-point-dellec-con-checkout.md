...
![](../../../DG2lpjf4Y5u7ZRFE7CyZ/.gitbook/assets/nuovo_modello1_carrello_V3_SANP_EC.png)

## Parametri della redirect <a href="#om57nyt5rga1" id="om57nyt5rga1"></a>

L'integrazione con Checkout è attivata per mezzo di una redirect innescata tramite una chiamata [POST](../../appendici/primitive/#ec-checkout-api) specificando i seguenti parametri :
