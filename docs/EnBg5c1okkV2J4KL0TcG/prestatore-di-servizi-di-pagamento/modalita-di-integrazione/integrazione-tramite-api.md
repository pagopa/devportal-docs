...
![](../../../pago-pa/sanp/3.11.0/.gitbook/assets/demandPaymentNotice.png)
...
![](../../../pago-pa/sanp/3.11.0/.gitbook/assets/verifyPaymentNotice.png)
...
![](<../../../pago-pa/sanp/3.11.0/.gitbook/assets/image (41).png>)
...
![](../../../pago-pa/sanp/3.11.0/.gitbook/assets/activatePaymentNotice.png)
...
![](../../../pago-pa/sanp/3.11.0/.gitbook/assets/pspNotifyPayment.png)
...
Se il PSP invia un KO nella response il processo di pagamento termina e deve essere effettuato uno storno, nel caso il PSP inviasse comunque una [sendPaymentOutcome](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) con _outcome_ OK tale esito verrebbe rifiutato dal nodo.

Se il PSP invia un OK nella response deve inviare un _outcome_ OK nella [sendPaymentOutcome](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome), nel caso in cui venisse inviato un KO il Nodo risponderà con un faultBean:
...
![](../../../pago-pa/sanp/3.11.0/.gitbook/assets/sendPaymentOutcome.png)
...
Per agevolare l’integrazione dei diversi sistemi di incasso la sessione di pagamento ha una durata limitata [(Best Practice](best-practice.md)), alla scadenza di tale tempo il pagamento si considererà non avvenuto.
...
L'invio di una [sendPaymentOutcome](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) con esito positivo (outcome = OK) è un impegno del PSP a riversare l’importo del pagamento all’EC, al netto dell'eventuali eccezioni con cui può rispondere il Nodo.
