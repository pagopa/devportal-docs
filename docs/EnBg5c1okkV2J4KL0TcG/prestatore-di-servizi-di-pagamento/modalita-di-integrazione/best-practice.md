...
Il _payment token_ è fornito in _response_ dalla piattaforma pagoPA ad una [activatePaymentNotice](../../appendici/primitive/psp/api-soap.md#activatepaymentnotice-1), deve essere inserito dal PSP in _request_ alla [sendPaymentOutcome](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) e assume il significato di _identificativoUnivocoRiscossione_ nei Flussi di Rendicontazione.

Per una corretta gestione di ogni sessione di pagamento ad ogni [activatePaymentNotice](../../appendici/primitive/psp/api-soap.md#activatepaymentnotice-1) deve sempre seguire una [sendPaymentOutcome](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) sia nel caso di OK che KO, in modalità real time rispetto alle azioni dell'utente presso il touch point del PSP, questo è fondamentale per gestire una buona qualità del servizio lungo tutta la filiera.

Successivamente alla ricezione di una risposta da parte del Nodo la [sendPaymentOutcome](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) non deve essere invocata nuovamente, per sopperire ai casi in cui non si riceva una response è necessario usare la [#chiave-di-idempotenza](best-practice.md#chiave-di-idempotenza "mention")
...
A fronte di un esito **OK** alla [sendPaymentOutcome ](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome)il PSP è tenuto a specificare i seguenti campi che quindi risultano obbligatori in caso di risposta affermativa:
...
* [activatePaymentNotice](../../appendici/primitive/psp/api-soap.md#activatepaymentnotice-1)
* [sendPaymentOutcome](../../appendici/primitive/psp/api-soap.md#sendpaymentoutcome)&#x20;
...
La durata della _chiave di idempotenza_ è impostata dalla piattaforma pagoPA, in base ad una configurazione comune a tutti i PSP, nel caso della [activatePaymentNotice](../../appendici/primitive/psp/api-soap.md#activatepaymentnotice-1) la durata massima non può essere superiore a quella del &#x70;_&#x61;yment token._

Nel caso di  [activatePaymentNotice](../../appendici/primitive/psp/api-soap.md#activatepaymentnotice-1) la _chiave di idempotenza_ deve essere invalidata, oltre ovviamente alla scadenza della chiave stessa, anche nel momento di ricezione di un esito per il _payment token_ generato durante l’attivazione.
