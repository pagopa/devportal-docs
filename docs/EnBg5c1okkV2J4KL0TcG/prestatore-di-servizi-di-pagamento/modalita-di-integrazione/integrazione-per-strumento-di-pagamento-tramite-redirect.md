...
Per le specifiche tecniche far rifermento alla [Retrieve redirect URL](../../appendici/primitive/psp/api-rest.md#redirections)
...
Per le specifiche tecniche far rifermento alla [Callback API for communicate authorization outcome](../../appendici/primitive/psp/api-rest.md#redirections-idtransaction-outcomes)&#x20;
...
Per le specifiche tecniche far rifermento all' [Api for refund](../../appendici/primitive/psp/api-rest.md#redirections-refunds)
