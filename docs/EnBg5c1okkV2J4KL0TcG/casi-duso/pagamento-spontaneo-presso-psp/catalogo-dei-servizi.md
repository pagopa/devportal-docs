...
![](../../../9E4vGfV6bOPGpOwZoKIm/.gitbook/assets/nodoChiediCatalogoServizi.png)

Le informazioni possono essere richieste dai singoli PSP alla piattaforma pagoPA utilizzando l'apposita primitiva [nodoChiediCatalogoServizi](../../appendici/primitive/psp/api-soap.md#nodochiedicatalogoservizi).
...
Di seguito un esempio di xml del Catalogo dei Servizi restituito nel tag _xmlCatalogoServizi_ in formato base64 tramite la primitiva [nodoChiediCatalogoServizi](../../appendici/primitive/psp/api-soap.md#nodochiedicatalogoservizi).
