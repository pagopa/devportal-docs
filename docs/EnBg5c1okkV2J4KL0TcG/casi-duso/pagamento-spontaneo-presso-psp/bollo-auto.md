...
![](../../../9E4vGfV6bOPGpOwZoKIm/.gitbook/assets/nuovoModello4_demand_ENG.png)

* La [demandPaymentNotice](../../appendici/primitive/#demandpaymentnotice) è utilizzabile dai PSP per inviare i dati del servizio specifico inseriti dall'utente, che nel caso attuale sono essenzialmente il numero di targa e la tipologia del veicolo;
