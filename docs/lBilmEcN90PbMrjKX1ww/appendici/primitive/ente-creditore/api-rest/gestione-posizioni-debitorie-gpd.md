...
<table data-full-width="true"><thead><tr><th>TABELLA DELLE SEZIONI</th></tr></thead><tbody><tr><td><a href="#inserimento-modifica-cancellazione-lettura">Inserimento-Modifica-Cancellazione-Lettura</a></td></tr><tr><td><a href="#flussi-di-rendicontazione---deprecated">Flussi di rendicontazione - DEPRECATED </a></td></tr><tr><td><a href="#inserimento-modifica-cancellazione-lettura---gestione-massiva-v1">Inserimento-Modifica-Cancellazione-Lettura - Gestione Massiva v1</a></td></tr><tr><td><a href="#inserimento-modifica-cancellazione-lettura---gestione-massiva-v2">Inserimento-Modifica-Cancellazione-Lettura - Gestione Massiva v2</a></td></tr><tr><td><a href="#recupero-ricevute">Recupero ricevute</a></td></tr><tr><td><a href="#inserimento-modifica-cancellazione-lettura-+-opzioni-di-pagamento">Inserimento-Modifica-Cancellazione-Lettura + Opzioni di Pagamento</a></td></tr></tbody></table>

### Inserimento-Modifica-Cancellazione-Lettura <a id="inserimento-modifica-cancellazione-lettura"></a>
...
*   [The Organization updates the IBANs of every updatable payment](https://developer.pagopa.it/pago-pa/api/gestione-posizioni-debitorie#/pago-pa/api/operations/updateTransferIbanMassive)

    [option's transfers](https://developer.pagopa.it/pago-pa/api/gestione-posizioni-debitorie#/pago-pa/api/operations/updateTransferIbanMassive)
...
### Flussi di rendicontazione - DEPRECATED  <a id="flussi-di-rendicontazione-deprecated"></a>
...
### Inserimento-Modifica-Cancellazione-Lettura - Gestione Massiva v1 <a id="inserimento-modifica-cancellazione-lettura-gestione-massiva-v1"></a>
...
### Inserimento-Modifica-Cancellazione-Lettura - Gestione Massiva v2 <a id="inserimento-modifica-cancellazione-lettura-gestione-massiva-v2"></a>
...
### Recupero ricevute <a id="recupero-ricevute"></a>
...
### Inserimento-Modifica-Cancellazione-Lettura + Opzioni di Pagamento <a id="inserimento-modifica-cancellazione-lettura-opzioni-di-pagamento"></a>
