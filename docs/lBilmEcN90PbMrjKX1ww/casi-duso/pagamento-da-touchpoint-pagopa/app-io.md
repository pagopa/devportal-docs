...
* l'utente che avvia il pagamento dall'app IO <img src="../../.gitbook/assets/image (7).png" alt="" data-size="line"> deve scansionare il QR code presente sull'avviso di pagamento;
