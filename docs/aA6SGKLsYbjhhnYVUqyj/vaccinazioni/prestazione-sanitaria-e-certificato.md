# 4️⃣ Prestazione sanitaria e certificato
...
* Il caricamento del certificato dovrebbe avvenire tempestivamente al termine della prestazione sanitaria.
* Il messaggio deve includere un link diretto al fascicolo sanitario per evitare passaggi superflui.
