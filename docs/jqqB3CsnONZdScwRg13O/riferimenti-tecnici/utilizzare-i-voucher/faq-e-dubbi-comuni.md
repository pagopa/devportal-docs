...
Un **esempio pratico di client assertion** è disponibile nella [sezione dedicata](https://docs.pagopa.it/interoperabilita-1/manuale-operativo/utilizzare-i-voucher#un-esempio-di-client-assertion).
