...
All’interno della richiesta, l’**oggetto della verifica** sono i **requisiti di accesso** (_attributi_) che l’**erogatore** ha definito come **condizione necessaria** per l’iscrizione.
