...
* Aggiunta delle funzionalità "ente certificatore"&#x20;
...
* Possibilità di importare ed esportare gli e-service da un ambiente all'altro
...
* Rilascio infrastrutturale propedeutico alla migrazione verso la region AWS di Milano

#### 1.0.111 (30 settembre)

* Accesso a Società a Controllo Pubblico (SCP)
...
Pagina successiva [→ Changelog 2023](changelog-2023.md)
