...
Prima di tutto, l'erogatore estrae dall'header della richiesta il voucher rilasciato da PDND Interoperabilità, e lo deserializza.
...
NB: il `client_id` è presente utilizza lo snake case invece del camel case per coerenza con l'RFC di riferimento.
...
Pagina successiva [→ Come verificare la validità di un voucher DPoP](come-verificare-la-validita-di-un-voucher-dpop.md)
