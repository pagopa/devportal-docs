...
PDND Interoperabilità autentica e autorizza gli aderenti, abilitando lo scambio di informazioni tra le parti. I dati presenti nelle banche dati dei quali gli erogatori sono titolari non transitano mai sulla piattaforma.
...
La clausola di "Limitazioni delle responsabilità" da parte di PagoPA S.p.A. è limitata a due aspetti specifici: l'ambiente di collaudo e la manutenzione. In questi casi, PagoPA S.p.A. non può garantire l'assenza di eventuali altre problematiche legate all'infrastruttura.
