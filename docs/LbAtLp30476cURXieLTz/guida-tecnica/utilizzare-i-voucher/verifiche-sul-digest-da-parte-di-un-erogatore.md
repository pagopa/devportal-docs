...
Quando si riceve una richiesta da un fruitore, è sempre necessario effettuare le verifiche sul voucher. Queste verifiche dipendono dal tipo di voucher: [Bearer](verifiche-su-un-voucher-bearer-da-parte-di-un-erogatore.md) o [DPoP](verifiche-su-un-voucher-dpop-da-parte-di-un-erogatore.md).
...
1. si autentica sulle API di PDND Interoperabilità come descritto nel [flusso dedicato](../../tutorial/fruitore/voucher/come-richiedere-un-voucher-bearer-per-le-api-di-pdnd-interoperabilita.md);
