...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/ehvH7YE5R9GDHFFfnCv1/riferimenti-normativi/riferimenti-e-documenti-ufficiali
---
...
* [**Specifiche attuative dei codici identificativi di versamento (SACI)**](https://developer.pagopa.it/pago-pa/guides/saci) **e** [**Specifiche attuative del nodo dei pagamenti SPC (SANP)**<br>](https://developer.pagopa.it/pago-pa/guides/sanp)La documentazione relativa alla piattaforma pagoPA
