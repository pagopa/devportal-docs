...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/ehvH7YE5R9GDHFFfnCv1/il-prodotto/lo-schema-sepa-request-to-pay-epc
---
...
![Four Corner Model](../../srtp/manuale-operativo-srtp/v1.1/.gitbook/assets/fourcornermodel.png)
