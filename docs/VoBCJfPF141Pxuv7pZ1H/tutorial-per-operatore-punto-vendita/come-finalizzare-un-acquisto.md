...
**Opzione A: Confermare il Pagamento**

* **Quando**: Il cittadino ha completato il pagamento della parte di importo a suo carico.
* **Azione**: L'Operatore clicca sul pulsante **"Conferma pagamento"** (o "Finalizza").

**Opzione B: Annullare la Transazione**

* **Quando**: Il cittadino decide di non procedere più all'acquisto o l'operazione non va a buon fine per qualsiasi motivo.
* **Azione**: L'Operatore clicca sul pulsante **"Annulla transazione"**.
...
* **In caso di Conferma Pagamento (Opzione A):**
  * Il buono sconto viene **accettato in via definitiva** e risulta "utilizzato".
  * La transazione cambia stato (es. "Completato") e viene spostata nello storico consultabile.
  * Il cittadino non può più utilizzare quel buono.
