...
Un cittadino si presenta al Punto Vendita e intende utilizzare il suo Bonus Elettrodomestici, mostrando il codice sconto (da App IO o cartaceo).
...
#### Step 3 - Blocco temporaneo del buono

Dopo aver inserito i dati, il sistema visualizza il riepilogo. L'Operatore verifica l'identità del cittadino (se necessario, in caso di buono cartaceo) e clicca su **"Accetta buono sconto"**. In questo momento, il buono viene bloccato e viene creata una transazione in attesa di finalizzazione.
