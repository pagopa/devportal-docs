...
schema:
  ...
  description: >-
    Questo tutorial descrive come accedere alla sezione 'Storico Caricamenti'
    per monitorare lo stato di elaborazione dei file CSV inviati e come
    scaricare i report in caso di errori.
  isPartOf:
    '@type': CreativeWork
