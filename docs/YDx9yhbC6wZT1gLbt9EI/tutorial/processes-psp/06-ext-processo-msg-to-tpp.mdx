---
title: Come inviare un Messaggio di Cortesia ai PSP
sidebar_label: Come inviare un Messaggio di Cortesia ai PSP
sidebar_position: 5
slug: /external/tutorial/processes-psp/message-delivery
---

import ArchitectureGraph from '../../../_diagrams/_processes/psp/_uc6_msg-to-tpp.mdx';
...
Per maggiori dettagli sul formato del payload, consultare le specifiche dell'API - [openapi-emd-ext-message](../../riferimenti-tecnici/openapi-emd-ext-message.mdx).
...
Il PSP **deve** implementare la validazione del payload JSON ricevuto secondo lo schema fornito. In particolare:
