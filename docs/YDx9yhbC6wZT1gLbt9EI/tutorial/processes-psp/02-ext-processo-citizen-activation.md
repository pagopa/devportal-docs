---
title: Come attivare un utente al servizio
sidebar_label: Come attivare un utente al servizio
sidebar_position: 2
slug: /external/tutorial/processes-psp/citizen-activation
---

import ArchitectureGraph from '../../../_diagrams/_processes/psp/_uc2_citizen_activation.mdx';
