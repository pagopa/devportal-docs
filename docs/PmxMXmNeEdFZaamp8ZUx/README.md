...
Nel contesto delle PA, per dare seguito ad un procedimento amministrativo è indispensabile conoscere le variazioni dei dati dei soggetti coinvolti, specialmente quando la cui titolarità sia di altre PA.&#x20;

Per un soggetto privato è ugualmente importante poter accedere a un dato sempre aggiornato.
