...
* Per allegare correttamente le posizioni debitorie alla notifica, i sistemi in capo all'ente devono valorizzare i campi previsti dalle specifiche di SEND descritte nel paragrafo successivo.
...
In caso di mancata apertura della notifica digitale entro i tempi indicati, SEND procederà con l'invio cartaceo.
