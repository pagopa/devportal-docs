---
description: >-
  L'ente, tramite i propri sistemi, identifica le persone interessate dal
  servizio Mensa scolastica e le invita a compilare l'iscrizione
---
...
L'ente, tramite i propri sistemi, comunica ai cittadini interessati un messaggio su IO che li informa dell’apertura delle iscrizioni alla mensa scolastica per i minori la cui struttura scolastica ne ptorevede il servizio.

## 2. Il cittadino riceve il messaggio e compila l'iscrizione

Il cittadino riceve su IO un messaggio che lo informa dell’apertura delle iscrizioni alla mensa scolastica.
...
* precompilare, se conosciuti, alcuni dati del cittadino;&#x20;
* rilevare la presenza di altri minori a carico del cittadino già iscritti alla struttura.

## 3. L'ente comunica al cittadino che la domanda è stata accolta

L'ente, tramite i propri sistemi, comunica al cittadino tramite messaggio su IO che la domanda è stata accolta.

Se previsto, il cittadino potrà ricevere aggiornamenti anche sulla richiesta per dieta speciale del minore.
