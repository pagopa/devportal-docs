...
* a fronte di eccezioni tecniche durante la chiamata alla [pspNotifyPayment vers. 2](../../appendici/primitive.md#pspnotifypayment) che impedissero di ricevere una response, il Nodo attenderebbe il verificarsi del primo dei seguenti eventi:
  * scadenza del payment token: il processo viene interrotto e il pagamento deve essere stornato;
  * ricezione della [sendPaymentOutcome vers. 2](../../appendici/primitive.md#sendpaymentoutcome-versione-1): il flusso procede normalmente, tenendo sempre presente che il PSP non può inviare un outcome = KO;
