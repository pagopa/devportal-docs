...
Per i dettagli [https://github.com/pagopa/pagopa-api/tree/SANP3.2.0](https://github.com/pagopa/pagopa-api/tree/SANP3.2.0)
...
{% openapi src="../../pago-pa/sanp/3.2.0/.gitbook/assets/checkout.yaml" path="/carts" method="post" %}
[checkout.yaml](../../pago-pa/sanp/3.2.0/.gitbook/assets/checkout.yaml)
{% endopenapi %}
