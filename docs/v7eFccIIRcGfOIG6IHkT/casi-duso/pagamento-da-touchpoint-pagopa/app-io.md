...
![](../../../pago-pa/sanp/3.2.0/.gitbook/assets/appIO_SANP.png)

* l'utente che avvia il pagamento dall'app IO <img src="../../../pago-pa/sanp/3.2.0/.gitbook/assets/image (1).png" alt="" data-size="line"> deve scansionare il QR code presente sull'avviso di pagamento;
