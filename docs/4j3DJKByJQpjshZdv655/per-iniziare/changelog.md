...
* Aggiunto riferimento obbligatorio all'Informativa Privacy
* Introdotta nuova tipografia basta su Titillium Pro
...
{% file src="../../pago-pa/avviso-pagamento/3.4.0/.gitbook/assets/guidatecnica_avvisoanalogico_v2.2.1_con_alleg (1).pdf" %}
