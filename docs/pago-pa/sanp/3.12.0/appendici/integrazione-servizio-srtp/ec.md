...
L’Ente Creditore è tenuto ad alimentare correttamente GPD (Gestioni Posizioni Debitorie) o ACA (Archivio Centralizzato Avvisi) tramite la primitiva GPD for ACA con i dati delle posizioni da incassare (cfr.[ SANP](https://developer.pagopa.it/pago-pa/guides/sanp/ente-creditore/modalita-dintegrazione/integrazione-tramite-api-asincrone)).
...
4. il pagatore notificato attraverso i touchpoint del PSP decide se accettare la richiesta o rifiutarla, il processo di pagamento seguirà le modalità operative e le strutture previste dalle SANP, in conformità con le regole di interazione con il Nodo dei Pagamenti.<br>

PagoPA S.p.A. agisce esclusivamente in qualità di Service Provider tecnico, senza responsabilità sul contenuto delle richieste SRTP, il quale resta in capo esclusivo all’Ente Creditore. PagoPA S.p.A. agisce come fornitore tecnico per l’instradamento automatico delle RTP secondo le regole definite.
