...
La navigazione del Checkout può avvenire in modalità Guest o autenticata. Viene richiesta una mail a cui inviare l’esito dell’operazione.

![](<../../.gitbook/assets/Screenshot 2026-03-23 alle 13.20.45.png>)

## Parametri della redirect <a href="#om57nyt5rga1" id="om57nyt5rga1"></a>

L'integrazione con Checkout è attivata per mezzo di una redirect innescata tramite la chiamata [POST carts](../../appendici/primitive/ente-creditore/api-rest/checkout.md) specificando i seguenti parametri :
...
* _idCart:_ identificativo del carrello attribuito dall'EC, il parametro viene inserito in fase di attivazione nel tag _paymentNote_ della [paGetPayment](../../appendici/primitive/ente-creditore/api-soap.md#pagetpayment)
* _returnUrls_: indirizzi di ritorno sul sito dell'ente creditore
  ...
  * returnWaitingUrl: casi di esito non noto per timeout flusso checkout
