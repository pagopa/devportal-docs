...
Con il prefisso 6/, l’EC segnala alla piattaforma che la velocità di veicolazione della Pd presso il debitore della stessa potrebbe comportare un effetto negativo ai fini dell’integrale pagamento dell’importo del credito della stessa Pd. La valutazione della realizzabilità o meno di tale effetto negativo è rimessa alla libera valutazione dell'Ente Creditore.&#x20;

Ciò detto, a titolo meramente esemplificativo, si segnala che, salva diversa valutazione dell'Ente Creditore, potrebbe valutare il ricorrere della situazione appena indicata, ossia di un possibile mancato pagamento dell'intero importo della Pd, nel caso in cui l’oggetto del pagamento possa essere oggetto di un ravvedimento operoso da parte del debitore, ossia che il tributo/servizio/importo dovuto che ha generato la Pd potrebbe essere pagato dal debitore senza l’applicazione di sanzioni ovvero con una riduzione delle sanzioni stesse, laddove il recapito presso il pagatore della Pd tramite SRTP sia anticipatorio della conoscenza formale dell’atto (di accertamento) presupposto alla Pd.

Sempre a titolo meramente esemplificativo, si segnala altresì come, salva sempre ogni diversa valutazione dell'Ente Creditore, potrebbe valutare il ricorrere della situazione appena indicata, ossia di un possibile mancato pagamento dell'intero importo della Pd,  ove la Pd  sia connessa all’esistenza di un processo di notificazione della richiesta di pagamento oggetto della Pd nei confronti del debitore, in quanto l’importo integrale (incluse le spese di notificazione) di tale Pd risulterà dovuto dal debitore solo a seguito dell’avvenuto perfezionamento nei suoi confronti della relativa notificazione.

L’EC, fermo restando il proprio diritto di vedersi restituite dal debitore in via integrale le spese di notificazione o altre spese indirette in quanto ripetibili nei suoi confronti potrebbe essere infatti interesse dell’EC aspettare l’avvenuto perfezionamento della relativa notificazione per poter liquidare e/o ripetere tali spese nei confronti del debitore all'atto del pagamento della Pd. Una possibile soluzione a tale evenienza potrebbe essere rappresentata dalla scelta da parte dell’EC di forfettizzare ex ante l’ammontare delle spese di notificazione e/o delle ulteriori voci di spesa (es. per spese indirette) ovvero considerare, se del caso, di recuperare con una distinta e successiva Pd il pagamento integrale delle spese di notificazione non precedentemente liquidate e pagate nei confronti del debitore.

Si precisa, stante il carattere meramente esemplificativo delle indicazioni fin qui esposte,  che il prefisso 6/ può essere utilizzato dall'Ente Creditore per ogni altra ragione che secondo l’EC giustifichi la richiesta alla piattaforma pagoPA di non veicolare la posizione debitoria, non essendoci alcun onere per EC di esporre o indicare la motivazione sottostante all’utilizzo del prefisso 6/.
