...
* unico avviso il cui importo sia accreditato su un unico conto dello stesso Ente beneficiario che ha creato la posizione debitoria ma suddiviso in più transfer all'interno della response della [paGetPayment](../appendici/primitive/ente-creditore/api-soap.md#pagetpayment) (c.d. ente mono-beneficiario multi-versamento multi-taxonomy);
