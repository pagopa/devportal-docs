...
Una volta elaborata la richiesta, alla mail indicata verranno inviati i parametri per l'accesso al folder SFTP contenente due subfolders, uno di input su cui depositare i file contenenti l'elenco delle posizioni debitorie da caricare (rif. [Specifiche tracciato di input](../../../../../../tJodTCyBhcpVzLFwZZ31/appendici/posizioni-debitorie/gestione-massiva/broken-reference/)), e uno di output dove la piattaforma fornirà l'esito del caricamento.
