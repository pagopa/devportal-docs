...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/EnBg5c1okkV2J4KL0TcG/prestatore-di-servizi-di-pagamento/quality-improvement
---
...
Non è consentito l’invio di una response a fronte di una [pspNotifyPaymentV1/V2](../appendici/primitive/psp/api-soap.md#pspnotifypayment) oltre il tempo massimo previsto da specifiche.
...
Non è consentito l’invio di una [sendPaymentOutcomeV1/V2](../appendici/primitive/psp/api-soap.md#sendpaymentoutcome), a fronte della conclusione della gestione del metodo [pspNotifyPaymentV1/V2](../appendici/primitive/psp/api-soap.md#pspnotifypayment) con esito positivo, oltre il tempo massimo previsto da specifiche.
...
Non è consentito l’invio di [sendPaymentOutcomeV1/V2](../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) a token scaduto, ossia oltre il tempo massimo di sessione.

Soglia massima consentita: 2% su base mensile.

Riferimento specifiche: [best-practice.md](modalita-di-integrazione/best-practice.md "mention").

### Nessun invio della sendPaymentOutcome \[DASPO]

E’ obbligatorio inviare una [sendPaymentOutcomeV1/V2](../appendici/primitive/psp/api-soap.md#sendpaymentoutcome) a fronte di una attivazione di pagamento, a prescindere dall'esito del pagamento.
