...
Ogni EC, al momento delle creazione di una nuova posizione debitoria, deve effettuare il censimento della stessa sull’ACA tramite la [paCreatePosition](../../appendici/primitive.md#pacreateposition); grazie alla proprietà di idempotenza, per mezzo della stessa API è possibile aggiornare la posizione.
...
La richiesta di creazione di una nuova posizione giunge all’ACA per mezzo della [paCreatePosition](../../appendici/primitive.md#pacreateposition), fornendo in input i seguenti dati:
...
Nei casi in cui il pagamento multibeneficiario venga gestito dal servizio [stand-in.md](../../specifiche-attuative-del-nodo-dei-pagamenti-spc/funzionamento-generale/stand-in.md "mention") di PagoPA S.p.A., le posizioni multibeneficiario verranno riversate al solo EC presente nel campo _fiscalCodePA_.
