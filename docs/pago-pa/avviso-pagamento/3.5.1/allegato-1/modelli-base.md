...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/vgIzxa0FaCZjmBRODLgd/allegato-1/modelli-base
---
...
{% file src="../.gitbook/assets/pagoPA-Avvisi-350-rataUnica.zip" %}
...
{% file src="../.gitbook/assets/pagoPA-Avvisi-350-rateMultiple.zip" %}
