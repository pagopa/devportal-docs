...
* Codice`010101P` - **Notifiche Violazioni al Codice della Strada con pagamento** \
  Tutte le tipologie di comunicazioni/verbali/solleciti relative a violazione al CdS (divieto di sosta, autovelox, ztl etc...)&#x20;
*   Codice`010102P` - **Notifiche Violazioni extra CdS con pagamento**&#x20;
...
*   Codice`010103N` - **Notifiche Violazioni al Codice della Strada senza pagamento**
...
* Codice [`010202N`](#user-content-fn-1)[^1] - **Notifiche Riscossione Tributi senza pagamento**\
...
* Codice `010401P` - **Notifiche per sollecito pagamento servizi scolastici con pagamento**\
...
* Codice `010401N` - **Notifiche atti servizi scolastici** **senza pagamento**\
  Tutte le tipologie di comunicazione relative al sollecito di pagamento servizi scolastici (es. mense, trasporto, rette, pre post scuola etc...)&#x20;
...
* Codice `010601N` - **Notifiche comunicazioni VL Ufficio Tecnico / SUAP senza pagamento**\
...
* Codice `010801P` - **Comunicazioni relative a riscossioni coattive e ingiunzioni fiscali con pagamento**\
...
*   Codice `020401P` - **Notifiche Istanze di diniego/accettazione esenzione con pagamento**
...
*   Codice `020402N` - **Notifiche Istanze di diniego/accettazione esenzione senza pagamento**
...
* Codice `030301P` - **Comunicazioni relative a riscossioni coattive e ingiunzioni fiscali con pagamento**\
...
* Codice `030302N` - **Comunicazioni relative a riscossioni coattive e ingiunzioni fiscali** **senza pagamento**\
...
* Codice `030401P` - **Comunicazioni relative a processi amministrativi di accesso agli atti con pagamento**\
...
* Codice `030402N` - **Comunicazioni relative a processi amministrativi di accesso agli atti senza pagamento**\
...
* Codice `070201P` - **Notifiche Violazioni extra CdS con pagamento**\
  Inviare le notifiche Extra Cds per le Province
* Codice `070202N` - **Notifiche Violazioni extra CdS senza pagamento**\
  Inviare le notifiche Extra Cds per le Province

### 0703 - Ordinanze

* Codice `070301P` - **Ordinanze Provinciali con pagamento**\
  Inviare le notifiche Extra Cds per le Province
* Codice `070302N` - **Ordinanze Provinciali senza pagamento**\
  Inviare le notifiche Extra Cds per le Province
