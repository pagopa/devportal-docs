...
NOTA: per i punti 3. 5. 6. PN conserva la documentazione postale che comprova questi eventi. Si può accedere e scaricare questa documentazione con le stesse modalità utilizzate per le [Attestazioni opponibili ai terzi](../attestazione-opponibili-ai-terzi.md) generate da PN&#x20;
