...
<figure><img src="../../../.gitbook/assets/image (5) (1).png" alt="" width="366"><figcaption></figcaption></figure>
...
Maggiori dettagli sugli attributi sono [qui](https://docs.pagopa.it/interoperabilita-1/manuale-operativo/attributi) e il video-tutorial è [qui](https://app.gitbook.com/s/zN9ui0XIE88QquJhyppA/).
...
Una volta creato un client, sarà possibile associarlo ad una finalità, entrando in _**Fruizione > Le tue finalità,**_ poi nel tab "Client associati" cliccare su "Aggiungi"
...
<figure><img src="../../../.gitbook/assets/image (14).png" alt="" width="304"><figcaption></figcaption></figure>
...
nellla prima pagina "Client assertion", potremo selezionare la chiave pubblica di riferimento e generare la client assertion con i comandi script che troviamo nella sezione in basso \
...
L'**access\_token(PDNDVoucher)** appena ottenuto corrisponde al Voucher che potrà essere utilizzato nelle chiamate verso i servizi B2B di SEND - UAT inserendolo come Header:&#x20;
