...
Tramite l’[Area Riservata](https://www.pagopa.it/it/area-riservata/), l’Ente deve generare le API key di produzione e accedere alla documentazione di SEND che guida le PA e i propri PT nel processo di integrazione.&#x20;

Una volta eseguito l’accesso a [Area Riservata](https://selfcare.pagopa.it/), cliccando sul prodotto attivo _**SEND Servizio Notifiche Digitali**_ il soggetto ha modo di generare le API key che deve consegnare al PT scelto con la documentazione tecnica a supporto dell’integrazione.&#x20;
...
1. Una notifica creata dall’API Key viene associata al gruppo
...
* il secret: di default è mascherato ma è presente un tasto che permette di visualizzarlo
...
Selezionata un’API Key attiva o ruotata, l’utente la blocca premendo il bottone _**Blocca**_.
...
Selezionata un’API Key bloccata, l’utente la elimina premendo il bottone _**Elimina**_.
...
Selezionata un’API Key bloccata, l’utente la riattiva premendo il bottone _**Riattiva**_.
