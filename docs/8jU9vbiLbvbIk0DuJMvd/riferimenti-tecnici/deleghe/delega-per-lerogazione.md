...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/jqqB3CsnONZdScwRg13O/riferimenti-tecnici/deleghe/delega-per-lerogazione
---
...
Pagina successiva [→ Delega per la fruizione](delega-per-la-fruizione.md)
