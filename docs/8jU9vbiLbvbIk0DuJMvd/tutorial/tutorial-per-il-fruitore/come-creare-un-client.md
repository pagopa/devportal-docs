...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/jqqB3CsnONZdScwRg13O/tutorial/tutorial-per-il-fruitore/come-creare-un-client
---
...
Per le best practice nella gestione dei propri client, si veda la [sezione dedicata](../../riferimenti-tecnici/client-e-materiale-crittografico/organizzazione-dei-propri-client.md).

***

Pagina successiva [→ Come associare un client ad una finalità](come-associare-un-client-ad-una-finalita.md)
