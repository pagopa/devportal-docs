...
Per i dettagli [https://github.com/pagopa/pagopa-api/tree/SANP3.4.0](https://github.com/pagopa/pagopa-api/tree/SANP3.4.0)
...
| paymentNote                                    | String | <p>Descrizione del pagamento. Valorizzato con</p><p><em>idCart</em></p><p>, nel caso il parametro venisse valorizzato nel</p><p><a data-mention href="../casi-duso/pagamento-presso-frontend-dellec.md">pagamento-presso-frontend-dellec.md</a></p> |
...
| primaryCiIncurredFee                                    | String | <p>importo della commissione a carico dell'EC espresso in euro associato a</p><p><a data-mention href="gestione-evoluta-commissioni.md">gestione-evoluta-commissioni.md</a></p>                                                                                                                          |
| IdBundle                                                | String | <p>identificativo del pacchetto associato a</p><p><a data-mention href="gestione-evoluta-commissioni.md">gestione-evoluta-commissioni.md</a></p>                                                                                                                                                         |
| IdCiBundle                                              | String | <p>identificativo degli attributi aggiunti dall'EC al pacchetto associato a</p><p><a data-mention href="gestione-evoluta-commissioni.md">gestione-evoluta-commissioni.md</a></p>                                                                                                                         |
...
{% openapi src="../../pago-pa/sanp/3.4.0/.gitbook/assets/checkout.yaml" path="/carts" method="post" %}
[checkout.yaml](../../pago-pa/sanp/3.4.0/.gitbook/assets/checkout.yaml)
{% endopenapi %}

## getOrganizationReceipt

{% openapi src="../../pago-pa/sanp/3.4.0/.gitbook/assets/bizEvents.yaml" path="/organizations/{organizationfiscalcode}/receipts/{iur}/paymentoptions/{iuv}" method="get" %}
[bizEvents.yaml](../../pago-pa/sanp/3.4.0/.gitbook/assets/bizEvents.yaml)
{% endopenapi %}

## paCreatePosition

{% openapi src="../../pago-pa/sanp/3.4.0/.gitbook/assets/paCreatePosition.yaml" path="/paCreatePosition" method="post" %}
[paCreatePosition.yaml](../../pago-pa/sanp/3.4.0/.gitbook/assets/paCreatePosition.yaml)
{% endopenapi %}
