...
![](../../../pago-pa/sanp/3.5.0/.gitbook/assets/demandPaymentNotice.png)
...
![](../../../pago-pa/sanp/3.5.0/.gitbook/assets/verifyPaymentNotice.png)
...
![](<../../../pago-pa/sanp/3.5.0/.gitbook/assets/image (41).png>)
...
![](../../../pago-pa/sanp/3.5.0/.gitbook/assets/activatePaymentNotice.png)
...
![](../../../pago-pa/sanp/3.5.0/.gitbook/assets/pspNotifyPayment.png)
...
Per un corretto e standardizzato utilizzo dei _metadata_ è stato creato un apposito [http://127.0.0.1:5000/o/KXYtsf32WSKm6ga638R3/s/u6YdY319vyFX9MIvnKBa/](http://127.0.0.1:5000/o/KXYtsf32WSKm6ga638R3/s/u6YdY319vyFX9MIvnKBa/ "mention"), in cui è presente una sezione dedicata alle informazioni del canale di pagamento presenti in _additionalPaymentInformations_ della [pspNotifyPayment vers. 2](../../appendici/primitive.md#versione-2-4).

## Fase di invio dell'esito del pagamento

![](../../../pago-pa/sanp/3.5.0/.gitbook/assets/sendPaymentOutcome.png)
...
Se la posizione è già stata pagata il Nodo restituisce il faultCode \_PPT\_PAGAMENTO\_DUPLICATO, s\_e, invece, non si trova alcun posizione di pagamento attivata il Nodo restituisce il faultCode _PPT\_PAGAMENTO\_SCONOSCIUTO_.
