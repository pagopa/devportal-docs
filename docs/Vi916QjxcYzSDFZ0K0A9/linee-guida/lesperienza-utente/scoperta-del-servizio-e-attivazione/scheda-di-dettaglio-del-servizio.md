...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/gCHOYTnMNSuUjwLmQkud/linee-guida/lesperienza-utente/scoperta-del-servizio-e-attivazione/scheda-di-dettaglio-del-servizio
---
...
Potrebbe essere utile aggiungere i vantaggi per il cliente:

* Maggiore comodità
* Esperienza utente migliorata
* Accesso rapido alle informazioni
* Maggiore probabilità di vedere e gestire le notifiche
* Possibilità di pagare direttamente con il proprio PSP o con altri metodi di pagamento
