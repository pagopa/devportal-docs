...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/gCHOYTnMNSuUjwLmQkud/linee-guida/review-e-approvazione
---

# ✅ Approvazione dei materiali di Comunicazione

Per la realizzazione di eventuali materiali di marketing legati alla funzionalità e comunicazione prodotti e divulgati da un PSP aderente, sarà sempre **necessario seguire le brand guidelines di SEND - Servizio Notifiche Digitali**, in cui sono riportate le indicazioni per il corretto utilizzo del logo e di tutti gli elementi della brand identity, al fine di assicurare la coerente e corretta applicazione del marchio.
