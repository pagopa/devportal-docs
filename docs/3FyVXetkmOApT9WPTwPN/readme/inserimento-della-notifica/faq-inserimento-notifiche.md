...
## Accesso, autenticazione e uso delle API
...
## Gestione e Upload dei Documenti
...
#### Chiarimenti su liberi professionisti e imprese individuali

* Le attività di lavoro autonomo o indipendente (non occasionali, con partita IVA), si possono suddividere principalmente in due macro categorie:
  * attività di impresa (ad es. ditte individuali di artigiani o commercianti come idraulici, pasticceri, parrucchieri, ecc.);
  * attività di lavoro autonomo intellettuale (ad es. liberi professionisti come notai, avvocati, artisti, giornalisti, medici, consulenti d’azienda, ecc.)
* Chi ha la Partita IVA e svolge attività di libero professionista o di ditta individuale viene identificato come forma di Persona Fisica (dal punto di vista giuridico anche l'impresa individuale è persona fisica perché non ha autonomia patrimoniale e si identifica con il titolare).
* Professionisti e imprenditore individuali devono quindi entrare dal [Portale del cittadino](https://cittadini.notifichedigitali.it/) (PF) e hanno entrambi codice fiscale alfanumerico di 16 cifre.
* La registrazione al [Portale imprese](https://imprese.notifichedigitali.it/) (PG) non riguarda quindi professionisti e ditte individuali ma le società: in quel caso al primo accesso viene chiesta l'identificazione del legale rappresentante che deve risultare censito nei pubblici registri (Registro Imprese, il portale con i dati e i documenti ufficiali della Camera di Commercio gestito da InfoCamere o, in subordine, Anagrafe Tributaria, la banca dati dell'Agenzia delle Entrate).
