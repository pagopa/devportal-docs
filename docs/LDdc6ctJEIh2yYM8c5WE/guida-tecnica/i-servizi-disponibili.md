...
Con l'e-service “[Attestazione - Identificativo utente](../tutorial/verifichiamo-la-correttezza-dellorganization-id-1.md)”  è possibile ottenere l'identificativo di un cittadino a partire da un criterio di ricerca.  Ha lo scopo di simulare un ente che possiede le informazioni aggiornate sui codici identificativi di tutti i cittadini.

## Verifica indirizzo digitale

Con l'e-service “[Attestazione - Verifica Indirizzo digitale](../tutorial/richiediamo-informazioni-sullindirizzo-digitale.md)” è possibile verificare la presenza e la correttezza di un determinato indirizzo digitale. Ha lo scopo di simulare un ente che possiede tutte le informazioni anagrafiche legate agli indirizzi digitali dei soggetti.
