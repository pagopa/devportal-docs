...
Per un'introduzione e una demo della funzionalità, si veda il [webinar dedicato](https://developer.pagopa.it/webinars/DevTalks-PDNDInterop-template-e-service).
