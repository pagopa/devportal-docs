...
Come descritto nella [sezione dedicata](ciclo-di-vita.md#creazione-e-gestione-delle-versioni), **la definizione degli attributi è a discrezione del creatore del template**. L'ente che deriva la propria istanza dal template **non può modificarli** autonomamente. Se ritiene ci siano incongruenze, deve contattare il creatore del template che eventualmente provvederà alla rettifica.
