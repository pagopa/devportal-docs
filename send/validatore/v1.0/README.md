...
1. Fai partire il tool `PnValidator` seguendo una delle modalità descritte nella sezione [Come eseguire PnValidator](../../../docs/niZ9BM7pjxsgBMMWBim1/come-eseguire-pnvalidator.md).
