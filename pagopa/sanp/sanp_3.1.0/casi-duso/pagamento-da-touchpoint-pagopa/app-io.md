...
![](../../../../../docs/pago-pa/sanp/3.1.0/.gitbook/assets/appIO_SANP.png)



* l'utente che avvia il pagamento dall'app IO <img src="../../../../../docs/pago-pa/sanp/3.1.0/.gitbook/assets/image (8).png" alt="" data-size="line"> deve scansionare il QR code presente sull'avviso di pagamento;
